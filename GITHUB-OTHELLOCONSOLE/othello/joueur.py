...
class JoueurHumain(Joueur):
    ...
    def choisir_coup(self, coups_possibles):
        ...
        """
        try:
            # On demande a l'utilisateur la position du coup qu'il souhaite jouer
            print("Quel coup voulez vous jouer ? : \n")
            x = int(input("x : "))
            y = int(input("y : "))
        ...
        # On retourne la position choisie
        return (x, y)
